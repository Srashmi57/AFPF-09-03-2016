...
if($islogin==$arrUser_Profile['Users']['user_id']){
$userStyleclass = "disabled='disabled'";
}
		...
		?>
			...
			<div class="cms-bgloader"></div>
				...
				<div class="col-md-8">
					...
					<button id="followbutton" class='btn btn-success' <?php echo $isloggedclass;?> <?php echo $userStyleclass;?> type="button" onclick="return followartist(<?php echo $arrUser_Profile['Users']['user_id'];?>);"><?php echo $txtfollow;?></button></div>
				...
				<div class="col-md-4 row text-center follower-mar">
					...
					<div class="col-md-12 total_likes_padding">
							...
							<ul id="navlist">
								<li><!-- <a href="javascript:void(0);" <?php echo $likescount>0? "onClick= 'return getlikelist(".$userid.")'":"";?>>Total votes</a> -->Total votes
					...
					?>
						  <div class="performer-info">
							   ...
							   <?php echo $count;?>
								 ...
								 <div class="row">
												<a class="artistmediatitle" onClick="return fnartistmediatitle(<?php echo $usermedia_id;?>);" id="<?php echo  $usermedia_id;?>" style="text-align: left;"><?php echo mb_strimwidth($usermedia_name,0, 12, "..");?></a>
												</div> 
												...
												?>
												<a class="artistmediatitle" id="<?php echo  $usermedia_id;?>" style="text-align: left;"><?php 
...
function getCookie(cname) {
 ...
 <div class="recentupload wow fadeInUp">
	<p style="color:white">RECENT UPLOADS</p>
</div>
