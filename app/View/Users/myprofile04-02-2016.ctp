...
<div class="container background" id="maincontent">
    ...
    <!-- Current avatar -->
    <div class="avatar-view" style="float: left;width: 66%;" >
		  ...
		  <div class="nav_class_body">
			<?php $p=1;$j=1; foreach($arr_CategoryList as $usercatkey=> $usercat) {
                ...
                if($usercat=='Dance' || $usercat=='Photography' || $usercat=='Freestyle' || $usercat=='Personality' || $usercat=='PersonalityMain'){
				  ...
				  $subsub_txt_style = 'margin-bottom: 1% !important;margin-top: 1% !important;';
				  $subsub_flotli_style= 'float:left;';
				  $selected_style = 'float: left;margin-bottom: 1% !important;margin-top: 1% !important;';
				}else{
...
function ShowSubSubCheckCat(mainId,usersubcat) {
...
function ShowSubSubSubCatcheck(mainId,usersubcat,usid) {
