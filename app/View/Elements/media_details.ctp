...
?>	
                                  	 <?php echo mb_strimwidth($artistmediaDetails['UserMedia']['usermedia_name'],0, 12, "..");?> (<?php echo $category_name;?>)
				...
				<?php
					break;
                            ...
                            <div class="comment-section">
							   <div class="media"><a  href="javascript:void(0);" <?php if( $islogin>0){ echo "style='cursor:none;'";} ?> onclick="<?php echo $islogin>0?'javascript:void(0);':"bootbox.alert('Please login to comment');"?>"><img src="<?php echo Router::url('/',true)?>images/chat-icon.png" alt="..." ></a>
                                		<div class="media-body">
											...
											<div class="col-md-12" id="followercount" style="color:white;white;position: absolute;left: 10px;top: -14px;">
