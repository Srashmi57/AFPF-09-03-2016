			...
			else
			{
				...
				if($boolUserprocessSaved)
				{
					...
					$message = '<p> Hello '.$name.',</p>
								...
								<p align="justify"> Welcome to our website! You, or someone using your email address, has completed registration at artformplatform.com. You can complete registration by clicking the following link: 
								<a href="http://www.artformplatform.com/afpf/Users/activate/'.$getInsertid_UsersID.'/'.$activationcode.'">http://www.artformplatform.com/afpf/Users/activate/'.$getInsertid_UsersID.'/'.$activationcode.'</a>
