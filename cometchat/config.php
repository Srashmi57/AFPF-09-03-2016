...
define('BASE_URL','/afpf/cometchat/');
...
$trayicon[] = array('facebook','Facebook Fan Page','modules/facebook/index.php','_popup','500','460','','1','');
...
$plugins = array('smilies','clearconversation','chattime','games','filetransfer','stickers','broadcast','audiochat','avchat');
...
$extensions = array('mobileapp','desktop','ads');
...
$crplugins = array('chattime','style','filetransfer','smilies','stickers');
...
$apikey = 'e1b0102c5309671ca24f60f914779bf3';     // API key for RESTful APIs for User Management on custom coded sites
