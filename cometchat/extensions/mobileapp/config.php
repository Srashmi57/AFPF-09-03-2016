...
$login_placeholder = '#C2C2C9';
$login_button_pressed = '#002832';
$login_button_text = '#FFFFFF';
$login_foreground_text = '#000000';
$actionbar_color = '#002832';
$actionbar_text_color = '#FFFFFF';
$left_bubble_color = '#E5E5E5';
$left_bubble_text_color = '#000000';
$right_bubble_color = '#002832';
$right_bubble_text_color = '#FFFFFF';
$tab_highlight_color = '#002832';
